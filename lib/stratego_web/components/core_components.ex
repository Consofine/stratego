defmodule StrategoWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(StrategoWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(StrategoWeb.Gettext, "errors", msg, opts)
    end
  end
